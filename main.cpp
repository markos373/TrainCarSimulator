...
void StudentTests() {
  ...
  PushBack(t, TrainCar::MakeEngine());
  int total_weight,num_engines,num_freight_cars,num_passenger_cars,num_dining_cars,num_sleeping_cars;
        TotalWeightAndCountCars(t,total_weight,num_engines,num_freight_cars,num_passenger_cars
                                ,num_dining_cars,num_sleeping_cars);
  std::cout << "total weight: " << total_weight << " , num_engines: " << num_engines << ", num_freight_cars: " << num_freight_cars <<
  " , num_passenger_cars: " << num_passenger_cars << " , num_dining_cars: " << num_dining_cars << " , num_sleeping_cars: " << num_sleeping_cars << std::endl;
  DeleteAllCars(t);
  MTRand_int32 mtrand_fixed_seed(40);
  ShipFreightHelper(mtrand_fixed_seed, 6, 24, 60, 15);
  t= NULL;
  PushBack(t, TrainCar::MakeEngine());  
  PushBack(t, TrainCar::MakeEngine());  
  PushBack(t, TrainCar::MakePassengerCar());
